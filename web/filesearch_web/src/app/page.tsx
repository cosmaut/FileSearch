...
const langMap: Record<string, LangConfig> = {
  ...
  fr: {
    title: "FileSearch | Recherche Anime",
...
export async function generateMetadata({
  ...
  if (q) {
    return {
      title: `${q} | FileSearch`,
      description: `${q} - 进入 FileSearch 首页并快速搜索相关动漫资源。`,
      robots: {
        index: true,
        follow: true,
      },
