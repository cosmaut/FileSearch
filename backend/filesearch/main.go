...
import (
	...
	"filesearch/service"
	"filesearch/util"
	"filesearch/util/cache"

	// 以下是插件的空导入，用于触发各插件的init函数，实现自动注册
	// 添加新插件时，只需在此处添加对应的导入语句即可
	_ "filesearch/plugin/hdr4k"
	_ "filesearch/plugin/gying"
	_ "filesearch/plugin/pan666"
	_ "filesearch/plugin/hunhepan"
	_ "filesearch/plugin/jikepan"
	_ "filesearch/plugin/panwiki"
	_ "filesearch/plugin/pansearch"
	_ "filesearch/plugin/panta"
	_ "filesearch/plugin/qupansou"
	_ "filesearch/plugin/susu"
	_ "filesearch/plugin/thepiratebay"
	_ "filesearch/plugin/wanou"
	_ "filesearch/plugin/xuexizhinan"
	_ "filesearch/plugin/panyq"
	_ "filesearch/plugin/zhizhen"
	_ "filesearch/plugin/labi"
	_ "filesearch/plugin/muou"
	_ "filesearch/plugin/ouge"
	_ "filesearch/plugin/shandian"
	_ "filesearch/plugin/duoduo"
	_ "filesearch/plugin/huban"
	_ "filesearch/plugin/cyg"
	_ "filesearch/plugin/erxiao"
	_ "filesearch/plugin/miaoso"
	_ "filesearch/plugin/fox4k"
	_ "filesearch/plugin/pianku"
	_ "filesearch/plugin/clmao"
	_ "filesearch/plugin/wuji"
	_ "filesearch/plugin/cldi"
	_ "filesearch/plugin/xiaozhang"
	_ "filesearch/plugin/libvio"
	_ "filesearch/plugin/leijing"
	_ "filesearch/plugin/xb6v"
	_ "filesearch/plugin/xys"
	_ "filesearch/plugin/ddys"
	_ "filesearch/plugin/hdmoli"
	_ "filesearch/plugin/yuhuage"
	_ "filesearch/plugin/u3c3"
	_ "filesearch/plugin/javdb"
	_ "filesearch/plugin/clxiong"
	_ "filesearch/plugin/jutoushe"
	_ "filesearch/plugin/sdso"
	_ "filesearch/plugin/xiaoji"
	_ "filesearch/plugin/xdyh"
	_ "filesearch/plugin/haisou"
	_ "filesearch/plugin/bixin"
	_ "filesearch/plugin/nyaa"
	_ "filesearch/plugin/djgou"
	_ "filesearch/plugin/xinjuc"
	_ "filesearch/plugin/aikanzy"
	_ "filesearch/plugin/qupanshe"
	_ "filesearch/plugin/xdpan"
	_ "filesearch/plugin/discourse"
	_ "filesearch/plugin/yunsou"
	_ "filesearch/plugin/ahhhhfs"
	_ "filesearch/plugin/nsgame"
	_ "filesearch/plugin/quark4k"
	_ "filesearch/plugin/quarksoo"
	_ "filesearch/plugin/sousou"
	_ "filesearch/plugin/ash"
	_ "filesearch/plugin/qqpd"
	_ "filesearch/plugin/weibo"
	_ "filesearch/plugin/feikuai"
	_ "filesearch/plugin/kkmao"
	_ "filesearch/plugin/alupan"
	_ "filesearch/plugin/ypfxw"
	_ "filesearch/plugin/mikuclub"
	_ "filesearch/plugin/daishudj"
	_ "filesearch/plugin/dyyj"
	_ "filesearch/plugin/meitizy"
	_ "filesearch/plugin/jsnoteclub"
	_ "filesearch/plugin/mizixing"
	_ "filesearch/plugin/lou1"
	_ "filesearch/plugin/yiove"
)
